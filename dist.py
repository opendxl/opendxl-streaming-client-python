...
VERSION = __import__('dxldbconsumerclient').get_version()
RELEASE_NAME = "dxldbconsumerclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxldbconsumerclient")])
...
print("\nRemoving dxldbconsumerclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxldbconsumerclient.egg-info"))
